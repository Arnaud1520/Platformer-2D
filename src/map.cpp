...
void Map::setBackgroundMap1(sf::RenderWindow &window)
{
...
void Map::setDoorMap1(sf::RenderWindow &window)
{
...
void Map::setKeyMap1(sf::RenderWindow &window)
{
  if (!Key1.loadFromFile("../assets/cle.png"))
  {
    return;
  }
  key1.setTexture(Key1);
...
{
  if (cle1 == true)
    key1.setPosition(sf::Vector2f(1300.f, 800.f));
  
  if (cle1 == false)
    key1.setPosition(sf::Vector2f(1200.f, 560.f));
  
}
void Map::setBlocMap1(sf::RenderWindow &window)
{
...
void Map::setBackgroundMap2(sf::RenderWindow &window)
{
...
void Map::setDoorMap2(sf::RenderWindow &window)
{
...
void Map::setKeyMap2(sf::RenderWindow &window)
{
   if (!Key2.loadFromFile("../assets/cle.png"))
  {
    return;
  }
  key2.setTexture(Key2);
...
{
  if (cle2 == false)
    key2.setPosition(sf::Vector2f(1200.f, 160.f));

  if (cle2 == true)
    key2.setPosition(sf::Vector2f(1300.f, 800.f));
}

void Map::setBlocMap2(sf::RenderWindow &window)
{
...
void Map::BackgroundMap3(sf::RenderWindow &window)
{
...
void Map::setDoorMap3(sf::RenderWindow &window)
{
  if (!doorT.loadFromFile("../assets/porte.png"))
  {
    return;
...
void Map::setKeyMap3(sf::RenderWindow &window)
{
  if (!Key3.loadFromFile("../assets/cle.png"))
  {
    return;
  }
  key3.setTexture(Key3);
...
{
  if (cle3 == false)
    key3.setPosition(sf::Vector2f(80.f, 480.f));

  if (cle3 == true)
    key3.setPosition(sf::Vector2f(1300.f, 800.f));
}


void Map::setBlocMap3(sf::RenderWindow &window)
{
